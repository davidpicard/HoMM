...
parser.add_argument("--num_worker", type=int, default=4)  # ok
parser.add_argument("--precision", type=str, default="bf16")  # ok
# augment param
parser.add_argument("--ra", type=bool, default=False)  # ok
parser.add_argument("--ra_prob", type=float, default=1.0)  # ok
...
# checkpoints
parser.add_argument("--checkpoint_dir", type=str, default="./ft_checkpoints/")  # ok
parser.add_argument("--load_weights", type=str, default=None, required=True)  # ok
